...
- Each layer definition may now contain a `priority_indexes` section that is used to adjust
  the `uv` `index` configuration when locking or building that layer (added in :issue:`144`).
