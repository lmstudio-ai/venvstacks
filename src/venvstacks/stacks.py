...
class LayerEnvBase(ABC):
    ...
    def _simplify_requirements(requirements_path: Path) -> tuple[str, ...]:
        ...
        return tuple(line.rstrip("\\").rstrip() for line in full_requirements if line and line[0] not in {"#", " "})
    ...
    def _write_package_summary(self) -> None:
        ...
        if constraints:
            ...
            required_packages = [line for line in required_packages if line not in shared_packages]
